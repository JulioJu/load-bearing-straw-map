...
import static org.lbstraw.map.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import org.lbstraw.map.config.Constants;
import org.lbstraw.map.domain.User;
import org.lbstraw.map.repository.AuthorityRepository;
import org.lbstraw.map.repository.UserRepository;
import org.lbstraw.map.security.AuthoritiesConstants;
import org.lbstraw.map.service.UserService;
import org.lbstraw.map.service.dto.AdminUserDTO;
import org.lbstraw.map.service.dto.PasswordChangeDTO;
import org.lbstraw.map.service.dto.UserDTO;
import org.lbstraw.map.web.rest.vm.KeyAndPasswordVM;
import org.lbstraw.map.web.rest.vm.ManagedUserVM;
