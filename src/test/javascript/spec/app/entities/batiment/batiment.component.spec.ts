...
import BatimentClass from '@/entities/batiment/batiment.component';
...
describe('Component Tests', () => {
  describe('Batiment Management Component', () => {
    ...
    beforeEach(() => {
      ...
      batimentServiceStub.retrieve.resolves({ headers: {} });

      wrapper = shallowMount<BatimentClass>(BatimentComponent, {
        store,
        i18n,
        localVue,
    ...
    it('Should call load all on init', async () => {
      // GIVEN
      batimentServiceStub.retrieve.resolves({ headers: {}, data: [{ id: 123 }] });

      // WHEN
      comp.retrieveAllBatiments();
      await comp.$nextTick();

      // THEN
      expect(batimentServiceStub.retrieve.called).toBeTruthy();
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      batimentServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(batimentServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(batimentServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      // GIVEN
      batimentServiceStub.delete.resolves({});
