...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.julioju.lbstrawmap.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.julioju.lbstrawmap.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, org.julioju.lbstrawmap.domain.User.class.getName());
